...
import {
  ...
  hideOthers,
  useFocusGuards
} from "./chunk-2UCISL27.js";
import {
  Item,
  Root,
  createRovingFocusGroupScope
} from "./chunk-ZEBEN2MA.js";
import {
  useId
} from "./chunk-HFQDRMQ5.js";
import {
  DismissableLayer,
  Portal
} from "./chunk-N7XZQUMI.js";
import {
  createCollection,
  useControllableState
} from "./chunk-VE5SB5SS.js";
import {
  queryOptions,
  useInfiniteQuery,
  useMutation,
...
import {
  ...
  mitt_default,
  signTransaction
} from "./chunk-MP3LG2MN.js";
import "./chunk-7PZA5AW2.js";
import "./chunk-GIOI3S5E.js";
import {
  Transaction,
  array,
  boolean,
  ...
  uuid,
  variant
} from "./chunk-YOKEV6IM.js";
import {
  useDirection
} from "./chunk-BLD7VZ7P.js";
import {
  Presence
} from "./chunk-QIFNAKX2.js";
import {
  composeEventHandlers,
  createContext2,
  createContextScope,
  useCallbackRef
} from "./chunk-JNDJPA5E.js";
import {
  Primitive,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React4 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState4 = React4.useState, useEffect4 = React4.useEffect, useLayoutEffect3 = React4.useLayoutEffect, useDebugValue2 = React4.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React4 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef5 = React4.useRef, useEffect4 = React4.useEffect, useMemo3 = React4.useMemo, useDebugValue2 = React4.useDebugValue;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React.Children.map(children, (child) => (0, import_jsx_runtime.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime.jsx)(Portal, { asChild: true, container: container8, children: child }) })) });
};
...
var Menu = (props) => {
  ...
  const [content4, setContent] = React2.useState(null);
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(PortalProvider2, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, container: container8, children }) }) });
};
...
function BackIcon(props) {
  return (0, import_jsx_runtime4.jsx)("svg", { width: 24, height: 24, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime4.jsx)(
    "path",
    {
...
function CloseIcon(props) {
  return (0, import_jsx_runtime5.jsx)("svg", { width: 10, height: 10, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime5.jsx)(
    "path",
    {
...
var StyleMarker = (0, import_react5.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime6.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
...
var IconButton = (0, import_react7.forwardRef)(
  ({ className, asChild = false, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime8.jsx)(Comp, { ...props, className: clsx_default(container, className), ref: forwardedRef });
  }
);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime11.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime11.jsx)(
      "img",
      {
    ...
    (0, import_jsx_runtime11.jsx)("div", { className: title2, children: (0, import_jsx_runtime11.jsxs)(Heading, { as: "h2", size: "xl", children: [
      "Opening ",
      selectedWallet.name
    ] }) }),
    (0, import_jsx_runtime11.jsx)("div", { className: connectionStatus, children: hadConnectionError ? (0, import_jsx_runtime11.jsx)(Text, { color: "danger", children: "Connection failed" }) : (0, import_jsx_runtime11.jsx)(Text, { color: "muted", children: "Confirm connection in the wallet..." }) }),
    hadConnectionError ? (0, import_jsx_runtime11.jsx)("div", { className: retryButtonContainer, children: (0, import_jsx_runtime11.jsx)(Button, { type: "button", variant: "outline", onClick: () => onRetryConnection(selectedWallet), children: "Retry Connection" }) }) : null
  ] });
}
var container3 = "InfoSection_container__1wtioi70";
function InfoSection({ title: title3, children }) {
  return (0, import_jsx_runtime12.jsxs)("section", { className: container3, children: [
    (0, import_jsx_runtime12.jsx)(Heading, { as: "h3", size: "sm", weight: "normal", children: title3 }),
    (0, import_jsx_runtime12.jsx)(Text, { weight: "medium", color: "muted", children })
  ] });
}
...
function GettingStarted() {
  return (0, import_jsx_runtime13.jsxs)("div", { className: container4, children: [
    (0, import_jsx_runtime13.jsx)(Heading, { as: "h2", children: "Get Started with Sui" }),
    (0, import_jsx_runtime13.jsxs)("div", { className: content2, children: [
      (0, import_jsx_runtime13.jsx)(InfoSection, { title: "Install the Sui Wallet Extension", children: "We recommend pinning Sui Wallet to your taskbar for quicker access." }),
      (0, import_jsx_runtime13.jsx)(InfoSection, { title: "Create or Import a Wallet", children: "Be sure to back up your wallet using a secure method. Never share your secret phrase with anyone." }),
      (0, import_jsx_runtime13.jsx)(InfoSection, { title: "Refresh Your Browser", children: "Once you set up your wallet, refresh this window browser to load up the extension." }),
      (0, import_jsx_runtime13.jsx)("div", { className: installButtonContainer, children: (0, import_jsx_runtime13.jsx)(Button, { variant: "outline", asChild: true, children: (0, import_jsx_runtime13.jsx)(
        "a",
        {
...
function WhatIsAWallet() {
  return (0, import_jsx_runtime14.jsxs)("div", { className: container5, children: [
    (0, import_jsx_runtime14.jsx)(Heading, { as: "h2", children: "What is a Wallet" }),
    (0, import_jsx_runtime14.jsxs)("div", { className: content3, children: [
      (0, import_jsx_runtime14.jsx)(InfoSection, { title: "Easy Login", children: "No need to create new accounts and passwords for every website. Just connect your wallet and get going." }),
      (0, import_jsx_runtime14.jsx)(InfoSection, { title: "Store your Digital Assets", children: "Send, receive, store, and display your digital assets like NFTs & coins." })
    ] })
  ] });
}
function SuiIcon(props) {
  return (0, import_jsx_runtime15.jsxs)("svg", { width: 28, height: 28, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: [
    (0, import_jsx_runtime15.jsx)("rect", { width: 28, height: 28, rx: 6, fill: "#6FBCF0" }),
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime16.jsx)("li", { className: container7, children: (0, import_jsx_runtime16.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime16.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
        (0, import_jsx_runtime16.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime16.jsx)("div", { children: name }) })
      ]
    }
  ) });
}
function WalletList({
  ...
  return (0, import_jsx_runtime17.jsx)("ul", { className: container6, children: wallets.length > 0 ? wallets.map((wallet) => (0, import_jsx_runtime17.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
    ...
    {
      name: "Sui Wallet",
      icon: (0, import_jsx_runtime17.jsx)(SuiIcon, {}),
...
function ConnectModal({
  ...
  switch (currentView) {
    case "what-is-a-wallet":
      modalContent = (0, import_jsx_runtime18.jsx)(WhatIsAWallet, {});
      break;
    case "getting-started":
      modalContent = (0, import_jsx_runtime18.jsx)(GettingStarted, {});
      break;
    case "connection-status":
      modalContent = (0, import_jsx_runtime18.jsx)(
        ConnectionStatus,
        {
          selectedWallet,
  ...
  return (0, import_jsx_runtime18.jsxs)(Root3, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    (0, import_jsx_runtime18.jsx)(Trigger, { asChild: true, children: trigger }),
    (0, import_jsx_runtime18.jsx)(Portal2, { children: (0, import_jsx_runtime18.jsx)(StyleMarker, { children: (0, import_jsx_runtime18.jsx)(Overlay, { className: overlay, children: (0, import_jsx_runtime18.jsxs)(Content2, { className: content, "aria-describedby": void 0, children: [
      (0, import_jsx_runtime18.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime18.jsxs)("div", { className: walletListContent, children: [
              (0, import_jsx_runtime18.jsx)(Title, { className: title, asChild: true, children: (0, import_jsx_runtime18.jsx)(Heading, { as: "h2", children: "Connect a Wallet" }) }),
      ...
      (0, import_jsx_runtime18.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime18.jsx)("div", { className: backButtonContainer, children: (0, import_jsx_runtime18.jsx)(IconButton, { type: "button", "aria-label": "Back", onClick: () => resetSelection(), children: (0, import_jsx_runtime18.jsx)(BackIcon, {}) }) }),
            modalContent
          ]
        }
      ),
      (0, import_jsx_runtime18.jsx)(Close, { className: closeButtonContainer, asChild: true, children: (0, import_jsx_runtime18.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime18.jsx)(CloseIcon, {}) }) })
    ] }) }) }) })
  ] });
}
...
function SuiClientProvider(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(SuiClientContext.Provider, { value: ctx, children });
}
...
function ChevronIcon(props) {
  return (0, import_jsx_runtime21.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime21.jsx)(
    "path",
    {
      stroke: "#A0B6C3",
      strokeLinecap: "round",
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime22.jsxs)(Root22, { modal: false, children: [
    (0, import_jsx_runtime22.jsx)(StyleMarker, { children: (0, import_jsx_runtime22.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime22.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime22.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress(currentAccount.address) }),
      (0, import_jsx_runtime22.jsx)(ChevronIcon, {})
    ] }) }) }),
    (0, import_jsx_runtime22.jsx)(Portal22, { children: (0, import_jsx_runtime22.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime22.jsxs)(Content23, { className: menuContent, children: [
      accounts.map((account) => (0, import_jsx_runtime22.jsx)(
      ...
      (0, import_jsx_runtime22.jsx)(Separator2, { className: separator }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime22.jsxs)(
    Item22,
    {
      ...
      children: [
        (0, import_jsx_runtime22.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress(account.address) }),
        active ? (0, import_jsx_runtime22.jsx)(CheckIcon, {}) : null
      ]
    }
  );
}
function ConnectButton({
  ...
  return currentAccount ? (0, import_jsx_runtime23.jsx)(AccountDropdownMenu, { currentAccount }) : (0, import_jsx_runtime23.jsx)(
    ConnectModal,
    {
      walletFilter,
      trigger: (0, import_jsx_runtime23.jsx)(StyleMarker, { children: (0, import_jsx_runtime23.jsx)(Button, { ...buttonProps, children: connectText }) })
    }
  );
}
...
function WalletProvider({
  ...
  return (0, import_jsx_runtime25.jsx)(WalletContext.Provider, { value: storeRef.current, children: (0, import_jsx_runtime25.jsxs)(
    WalletConnectionManager,
    {
      ...
      slushWallet,
      children: [
        theme ? (0, import_jsx_runtime25.jsx)(InjectedThemeStyles, { theme }) : null,
        children
      ]
    }
  ) });
