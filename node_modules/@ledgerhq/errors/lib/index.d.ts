...
export declare const HederaInsufficientFundsForAssociation: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const HederaRecipientTokenAssociationRequired: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const HederaRecipientTokenAssociationUnverified: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
